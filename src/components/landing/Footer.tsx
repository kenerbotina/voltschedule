...
export const Footer = () => {
  return (
    <footer className="bg-[#080a0c] border-t border-white/5">
...
<div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4 uppercase tracking-[0.2em] text-[10px] font-bold">
  ...
  <div>
    <p className="text-[#00f2ff] mb-4">Producto</p>
    <ul className="space-y-2">
      <li>
        <Link to="/features" className="text-gray-500 hover:text-white transition-colors">
          Features
        </Link>
      </li>
      <li>
        <Link to="/sync" className="text-gray-500 hover:text-white transition-colors">
          Sincronización
        </Link>
      </li>
      <li>
      ...
      <li>
        <Link to="/protocol" className="text-gray-500 hover:text-white transition-colors">
          Protocolo
        </Link>
      </li>
    </ul>
  ...
  <div>
    <p className="text-[#00f2ff] mb-4">Legal</p>
    <ul className="space-y-2">
      <li>
        <Link to="/privacy" className="text-gray-500 hover:text-white transition-colors">Privacidad</Link>
      </li>
      <li>
        <Link to="/terms" className="text-gray-500 hover:text-white transition-colors">Términos</Link>
      </li>
    </ul>
  </div>
</div>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-white/5 sm:flex-row">
  ...
  <div className="flex items-center mt-4 space-x-4 sm:mt-0 text-gray-500">
    ...
    className="hover:text-[#00f2ff] transition-all hover:scale-110"
  >
